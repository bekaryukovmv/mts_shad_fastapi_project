...
__all__ = ["IncomingBook", "ReturnedAllBooks", "ReturnedBook", "ReturnedBookWithoutSellerId"]
...
# Класс, валидирующий исходящие данные. Не содержит seller_id
class ReturnedBookWithoutSellerId(BaseBook):
    id: int
    count_pages: int